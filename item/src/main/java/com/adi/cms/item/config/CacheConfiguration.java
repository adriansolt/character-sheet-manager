package com.adi.cms.item.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.adi.cms.item.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.adi.cms.item.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.adi.cms.item.domain.User.class.getName());
