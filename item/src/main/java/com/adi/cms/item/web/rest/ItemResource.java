...
import com.adi.cms.item.repository.ItemRepository;
import com.adi.cms.item.service.ItemService;
...
/**
 * REST controller for managing {@link com.adi.cms.item.domain.Item}.
 */
@RestController
@RequestMapping("/api")
public class ItemResource {
    ...
    private static final String ENTITY_NAME = "itemItem";
     ...
     */
    @GetMapping("/items")
    public ResponseEntity<List<ItemDTO>> getAllItems(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
