...
@RestController
@RequestMapping("/api/item-kafka")
public class ItemKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ItemKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ItemKafkaResource(KafkaProperties kafkaProperties) {
