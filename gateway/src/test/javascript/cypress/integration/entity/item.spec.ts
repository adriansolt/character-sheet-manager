...
describe('Item e2e test', () => {
  ...
  const itemSample = { name: 'Metal', weight: 62690, quality: 30539 };
  ...
  describe('Item page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('edit button click should load edit Item page', () => {
  ...
  describe('new Item page', () => {
    ...
    it('should create an instance of Item', () => {
      cy.get(`[data-cy="name"]`).type('Burg Cotton').should('have.value', 'Burg Cotton');

      cy.get(`[data-cy="description"]`).type('Designer deposit').should('have.value', 'Designer deposit');

      cy.get(`[data-cy="weight"]`).type('80157').should('have.value', '80157');

      cy.get(`[data-cy="quality"]`).type('31031').should('have.value', '31031');
