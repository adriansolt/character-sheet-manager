...
describe('Weapon Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'weapon', component: WeaponComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.weapons?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
