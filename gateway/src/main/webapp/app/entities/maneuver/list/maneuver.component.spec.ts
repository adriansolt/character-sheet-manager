...
describe('Maneuver Management Component', () => {
  let comp: ManeuverComponent;
  let fixture: ComponentFixture<ManeuverComponent>;
  let service: ManeuverService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'maneuver', component: ManeuverComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ManeuverComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.maneuvers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
