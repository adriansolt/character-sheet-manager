...
describe('CharacterAttribute Management Component', () => {
  let comp: CharacterAttributeComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'character-attribute', component: CharacterAttributeComponent }]),
      ...
      .overrideTemplate(CharacterAttributeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.characterAttributes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
