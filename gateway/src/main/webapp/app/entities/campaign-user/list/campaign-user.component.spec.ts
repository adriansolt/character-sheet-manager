...
describe('CampaignUser Management Component', () => {
  let comp: CampaignUserComponent;
  let fixture: ComponentFixture<CampaignUserComponent>;
  let service: CampaignUserService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'campaign-user', component: CampaignUserComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(CampaignUserComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.campaignUsers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
