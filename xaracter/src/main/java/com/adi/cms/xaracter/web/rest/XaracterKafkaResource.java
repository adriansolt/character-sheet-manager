...
@RestController
@RequestMapping("/api/xaracter-kafka")
public class XaracterKafkaResource {

    private final Logger log = LoggerFactory.getLogger(XaracterKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public XaracterKafkaResource(KafkaProperties kafkaProperties) {
