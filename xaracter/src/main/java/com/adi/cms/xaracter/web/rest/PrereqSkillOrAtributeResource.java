...
import com.adi.cms.xaracter.repository.PrereqSkillOrAtributeRepository;
import com.adi.cms.xaracter.service.PrereqSkillOrAtributeService;
...
/**
 * REST controller for managing {@link com.adi.cms.xaracter.domain.PrereqSkillOrAtribute}.
 */
@RestController
@RequestMapping("/api")
public class PrereqSkillOrAtributeResource {
    ...
    private static final String ENTITY_NAME = "xaracterPrereqSkillOrAtribute";
