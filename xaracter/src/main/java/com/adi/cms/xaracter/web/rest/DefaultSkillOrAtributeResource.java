...
import com.adi.cms.xaracter.service.DefaultSkillOrAtributeService;
...
/**
 * REST controller for managing {@link com.adi.cms.xaracter.domain.DefaultSkillOrAtribute}.
 */
@RestController
@RequestMapping("/api")
public class DefaultSkillOrAtributeResource {
    ...
    private static final String ENTITY_NAME = "xaracterDefaultSkillOrAtribute";
