...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.adi.cms.campaign.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.adi.cms.campaign.repository.UserRepository.USERS_BY_EMAIL_CACHE);
