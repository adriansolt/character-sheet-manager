...
@RestController
@RequestMapping("/api/campaign-kafka")
public class CampaignKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CampaignKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CampaignKafkaResource(KafkaProperties kafkaProperties) {
