...
import com.adi.cms.campaign.service.CampaignService;
...
/**
 * REST controller for managing {@link com.adi.cms.campaign.domain.Campaign}.
 */
@RestController
@RequestMapping("/api")
public class CampaignResource {
    ...
    private static final String ENTITY_NAME = "campaignCampaign";
    ...
    public ResponseEntity<CampaignDTO> partialUpdateCampaign(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, campaignDTO.getId().toString())
        );
    }
