...
@RestController
@RequestMapping("/api/character-kafka")
public class CharacterKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CharacterKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CharacterKafkaResource(KafkaProperties kafkaProperties) {
